...
import {
  ...
  getDocument,
  isButton,
} from "ariakit-changesets-test-utils/dom";
import {
  addGlobalEventListener,
  queueBeforeEvent,
} from "ariakit-changesets-test-utils/events";
import {
  ensureFocus,
  focusIfNeeded,
  getFirstTabbableIn,
  getLastTabbableIn,
  isFocusable,
} from "ariakit-changesets-test-utils/focus";
import {
...
import { chain } from "ariakit-changesets-test-utils/misc";
import {
  isApple,
  isFirefox,
  isSafari,
} from "ariakit-changesets-test-utils/platform";
import {
  createComponent,
  createElement,
  createHook,
 ...
 * ariakit-changesets-test component to render a dialog element.
 * @see https://ariakit-changesets-test.org/components/dialog
 * @example
 * ```jsx
