...
import { contains, getDocument } from "ariakit-changesets-test-utils/dom";
import { addGlobalEventListener } from "ariakit-changesets-test-utils/events";
import { ensureFocus } from "ariakit-changesets-test-utils/focus";
import {
  useEventCallback,
  useLiveRef,
...
export function useHideOnInteractOutside(
  ...
  useEventOutside({
    ...
    listener: (event) => {
      ...
      // Fix for https://github.com/ariakit-changesets-test/ariakit-changesets-test/issues/619
