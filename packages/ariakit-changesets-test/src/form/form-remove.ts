...
import { useStore } from "ariakit-changesets-test-utils/store";
import {
  createComponent,
  createElement,
  createHook,
 ...
 * ariakit-changesets-test component to render a button that will remove an item from an array
 * field in the form when clicked.
 * @see https://ariakit-changesets-test.org/components/form
 * @example
 * ```jsx
