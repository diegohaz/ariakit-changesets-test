...
import { getPopupRole } from "ariakit-changesets-test-utils/dom";
import { queueBeforeEvent } from "ariakit-changesets-test-utils/events";
import {
...
import { useStoreProvider } from "ariakit-changesets-test-utils/store";
import {
  createComponent,
  createElement,
  createHook,
 ...
 * ariakit-changesets-test component to render a select button.
 * @see https://ariakit-changesets-test.org/components/select
 * @example
 * ```jsx
