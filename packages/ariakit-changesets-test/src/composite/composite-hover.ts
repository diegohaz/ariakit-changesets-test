...
import { closest, contains } from "ariakit-changesets-test-utils/dom";
import { addGlobalEventListener } from "ariakit-changesets-test-utils/events";
import { hasFocusWithin } from "ariakit-changesets-test-utils/focus";
import {
 ...
 * ariakit-changesets-test component to render an element in a composite widget that receives
...
export const useCompositeHover = createHook<CompositeHoverOptions>(
  ({ state, focusOnHover = true, ...props }) => {
    ...
    useEffect(() => {
      ...
      // See https://github.com/ariakit-changesets-test/ariakit-changesets-test/issues/1137
