 ...
 * ariakit-changesets-test component to render an element that can be shown or hidden.
 * @see https://ariakit-changesets-test.org/components/disclosure
 * @example
 * ```jsx
...
export const useDisclosureContent = createHook<DisclosureContentOptions>(
  ({ state, ...props }) => {
    ...
    useEffect(() => {
      ...
      // See https://github.com/ariakit-changesets-test/ariakit-changesets-test/issues/643
