...
import { useEventCallback, useId } from "ariakit-changesets-test-utils/hooks";
import {
  createMemoComponent,
  useStore,
 ...
 * ariakit-changesets-test component to render a tab element. The underlying element must be
 * wrapped in a `TabList` component or a component that implements the
 * `useTabList` props.
 * @see https://ariakit-changesets-test.org/components/tab
 * @example
 * ```jsx
